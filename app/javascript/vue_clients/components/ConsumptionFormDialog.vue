          ...
          <v-layout wrap>
            <v-flex xs12 class="form-fields compact-form">
              <div class="form-section">
                <h3 class="form-header">Votre Bien</h3>
                <div>
...
export default {
  ...
  data: () => ({
    ...
    washer: true,
    dryer: false,
    listHome: ["à usage d'habitation", "à usage professionnel"],
  ...
  methods: {
    ...
    calculateConsumption() {
      ...
      const type_heating = () => {
        return this.heating == "Electricité" ? 1 : 0;
      };
      const type_hot_water = () => {
        return this.hot_water == "Chaudière individuelle" ? 1 : 0;
      };
      const people = parseInt(this.nb_people);
      const fridge_consumption = () => {
        return this.fridge ? estimateData.fridge : 0;
      };
      const freezer_consumption = () => {
        return this.freezer ? estimateData.freezer : 0;
      };
      const dishwasher_consumption = () => {
        return this.dishwasher ? estimateData.dishwasher : 0;
      };
      const washer_consumption = () => {
        return this.washer ? estimateData.washer : 0;
      };
      const dryer_consumption = () => {
        return this.dryer ? estimateData.dryer : 0;
      };
      const oven_consumption = () => {
        return this.oven ? estimateData.oven_per_person * people : 0;
      };
      const calculated_form = () => {
        return (
          ...
          estimateData.computer_per_person * people +
          estimateData.lighting_per_person * people +
          estimateData.vacum +
          estimateData.microwave +
          estimateData.tv
        );
      };
